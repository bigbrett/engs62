...
#define NVIC_INTERRUPT_USART_3_ENABLE()       (NVIC_ISER3 = 0x00000080)
#define NVIC_INTERRUPT_USART_3_DISABLE()      (NVIC_ICER3 = 0x00000080)

/* Enable interrupts for both USART2 and USART3 */
#define NVIC_INTERRUPT_USART_2_3_ENABLE()       (NVIC_ISER2 = 0x000000C0)
#define NVIC_INTERRUPT_USART_2_3_DISABLE()      (NVIC_ICER2 = 0x000000C0)
